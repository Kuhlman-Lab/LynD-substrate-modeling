...
from modules.utils import (
    ...
    sample_random_peptides_templated
)
...
if __name__ == "__main__":
    ...
    # Create config for pre-trained model
    params = {
        'features': 'onehot', 
        'model': 'MLP', 
        'learning_rate': 0.01, 
    ...
    # Specify sets of semi-random peptides to screen
    # Note: 'X' indicates any residue but Cys can be placed there
